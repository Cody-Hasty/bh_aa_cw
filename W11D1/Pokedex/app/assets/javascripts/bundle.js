...
document.addEventListener('DOMContentLoaded', function () {
  ...
  window.fetchPokemon = _util_api_util__WEBPACK_IMPORTED_MODULE_3__["fetchPokemon"];

  var getSuccess = function getSuccess(pokemon) {
    return console.log(Object(_actions_pokemon_actions__WEBPACK_IMPORTED_MODULE_2__["receiveAllPokemon"])(pokemon));
  };

  Object(_util_api_util__WEBPACK_IMPORTED_MODULE_3__["fetchAllPokemon"])().then(getSuccess);
...
var fetchPokemon = function fetchPokemon(pokemon_id) {
  return $.ajax({
    url: "/api/pokemon/".concat(pokemon_id),
    method: 'GET'
  });
};
